        ...
        {rippleBoxes.map((box, i) => (
          <motion.div
            ...
            style={{
              ...
              opacity: box.opacity,
              ...({
                '--shadow-pulse-1': 'rgba(0,0,0,0.03)',
                '--shadow-pulse-2': 'rgba(0,0,0,0.06)',
              } as React.CSSProperties),
            }}
            className={cn(
              'absolute rounded-full border-2 border-border/50 bg-linear-to-b from-muted/10 to-muted/20',
              'dark:[--shadow-pulse-1:rgba(0,0,0,0.3)] dark:[--shadow-pulse-2:rgba(0,0,0,0.5)]'
            )}
            animate={{
              scale: [1, 1.15, 1],
              boxShadow: [
                'var(--shadow-pulse-1) 0px 5px 10px 0px',
                'var(--shadow-pulse-2) 0px 15px 20px 0px',
                'var(--shadow-pulse-1) 0px 5px 10px 0px',
              ],
            }}
            transition={{
          ...
          >
            {orbitIcons.map((social, localIndex) => {
              ...
              return (
                ...
                >
                  <motion.div
                    className='flex items-center justify-center w-12 h-12 rounded-full bg-background text-foreground border-2 border-border shadow-sm dark:shadow-lg'
                    style={{
                      animation: rotationStarted
